...
The distribution of C-14 in ocean is close related with input of C-14 atmosphere to ocean, history of surface ocean $$\Delta^{14}C$$($$\frac{{14}^C}{{12}^C}$$) excess and average $$CO_2$$ invasion rate (Broecker et al. 1985).
