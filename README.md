...
The distribution of C-14 in ocean is close related with input of C-14 atmosphere to ocean, history of surface ocean $$\Delta_{i=1}^n X_i$$
$\Delta$^{14}C excess and average C02 invasion rate (Broecker et al. 1985)
